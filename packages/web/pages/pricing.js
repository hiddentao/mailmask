...
import { FaqLink, SelfHostingLink } from '../src/frontend/components/Link'
...
const PricingPage = () => {
  ...
  return (
    <Layout>
      <Seo title='Pricing' description='Mailmask pricing and plan details.' />
      <ContentWrapper>
        <Container>
          <H1>Pricing</H1>
          <H2>Simple and transparent. No hidden fees. Cancel anytime.</H2>
