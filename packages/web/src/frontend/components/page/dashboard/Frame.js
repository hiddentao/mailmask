...
const AliasesPanel = ({ me }) => (
  <Main>
    <h1>My aliases</h1>
    <Example>Example: Send an email to <strong>{buildMaskAddress('test', me.usernames[0].username, DOMAIN)}</strong> to see the alias <strong>test</strong> show up below.</Example>
    <StyledMasks me={me} />
  </Main>
)
