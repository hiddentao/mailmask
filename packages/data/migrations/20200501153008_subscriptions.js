...
exports.up = async function (knex) {
  ...
  await schema(knex).createTable('sub', table => {
    ...
    table.enu('plan', Object.values(SUB.PLAN)).notNullable()
    table.enu('schedule', Object.values(SUB.SCHEDULE)).notNullable()
    table.enu('status', Object.values(SUB.STATUS)).notNullable()
  ...
  await schema(knex).createTable('payment', table => {
    ...
    table.enu('status', Object.values(SUB.PAYMENT_STATUS)).notNullable()
    addTimestampColumns(knex, table)
