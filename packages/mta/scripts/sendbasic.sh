...
swaks --from hello@msk.sh --to mask1@test.msk.sh,mask2@test.msk.sh,mask3@test.msk.sh,mask1@test3.msk.sh,mask1@invaliduser.msk.sh,mask2@invaliduser.msk.sh --server 127.0.0.1 "$@"
