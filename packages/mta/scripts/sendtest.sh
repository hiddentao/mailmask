...
swaks --to camo1@test.mmk.vc,camo2@test.mmk.vc,camo3@test.mmk.vc,camo1@test3.mmk.vc,camo1@invaliduser.mmk.vc,camo2@invaliduser.mmk.vc --server 127.0.0.1 --port 50025
